            ...
            >
                {list.map((slide, i) => {
                    ...
                    const cardStyle: CSSProperties = {
                        ...
                        backgroundColor: "var(--gallery-surface, var(--ink-bg, #1a1a1a))",
                    }
                        ...
                        >
                                ...
                                <>
                                    ...
                                    <div
                                        style={{
                                            ...
                                            inset: 0,
                                            background: isTop
                                                ? "linear-gradient(0deg, transparent 35%, var(--gallery-overlay, rgb(48 58 45 / 72%)) 100%)"
                                                : "linear-gradient(180deg, transparent 35%, var(--gallery-overlay, rgb(48 58 45 / 72%)) 100%)",
                                            pointerEvents: "none",
                                        }}
                                    />
                            ...
                            <div
                                style={{
                                    position: "absolute",
                                    inset: 0,
                                    background: "var(--gallery-dim, var(--gallery-surface, var(--ink-bg, #1a1a1a)))",
